...
\title{
    ...
    titlept={Uma comparação do desempenho de modelos de previsão para prever demanda por cimento},
    titleen={},
...
\begin{dedicatoria}
Dedico este trabalho aos meus pais, minha família e a Deus, cuja
ajuda e cujo apoio foi essencial para minha evolução e conquistas.
Obrigada.
\end{dedicatoria}
