...
empregos, de acordo com \citet{cbic-report}.
...
como "cimento de \textit{portland}". (\cite{boletim-cimento})} é uma das principais matérias
...
britada, pó-de-pedra e cal, este cimento se torna argamassa ou
concreto, utilizados em construções. (\cite{boletim-cimento})

\section*{Motivação}

A falta de um modo bem fundamentado para prever o 
...
demorou três anos e custou cerca de 200 milhões de reais, conforme 
...
modo a reduzir os riscos do setor. Com isso, seria possível apoiar órgãos 
governamentais a direcionar ações para mitigar o impacto ambiental da
fabricação desse produto, pontuado em \citet{meio-ambiente} como um grande emissor de 
gases de efeito-estufa em escala mundial.

%valeu a pena a grana da votorantin?

\section*{Objetivos}

Este trabalho propõe o uso de modelos de aprendizado de máquina para prever o 
consumo mensal de cimento nos estados do Brasil
como solução a necessidade da indústria por um meio de prever a demanda 
do material e investiga 
...
regressão linear, redes neurais \textit{feed forward} 
