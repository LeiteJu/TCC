...
Contudo, a falta de um modo bem fundamentado para prever a demanda de cimento é 
uma dor entre as empresas cimenteiras, uma vez que a construção de uma fábrica 
é custosa e demorada, além disso, aumentar a capacidade de produção de uma 
fábrica também é um processo custoso. 

Dessa forma, um modelo que permitisse prever a demanda a nível de 
...
demanda por cimento nos estados do Brasil. Os modelos avaliados são: 
