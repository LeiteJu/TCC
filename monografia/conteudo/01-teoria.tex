...
Entretanto, já em 1950, Alan Turing já se perguntava se máquinas 
poderiam pensar  e desenvolvia estudos no tema que permanecem relevantes
...
do Jogo da Imitação onde uma entrevistador deve fazer perguntas a dois jogadores, um 
humano e uma máquina, sem qualquer distinção. Ao final, o entrevistador deve
descobrir qual dos jogadores é uma máquina e qual é a pessoa.}.
O termo "inteligência artificial, não apresenta uma definição 
única e aceita, conforme 
relembra \cite{wang2019defining}, uma possível definição 
segundo a capacidade de um sistema de 
de se adaptar a um ambiente sem sem conhecimento ou recursos
suficientes\cite{wang_ai_def}.

% fazer uma transição pra aprendizado de máquina
% está meio abrupto
% vem do ingles tá meio estranho 
O aprendizado de máquina ou  
\textit{machine learning} em inglês, por outro lado, 
compreende sistemas de inteligência artificial capazes 
de adquirir seu próprio conhecimento ao extrair
 padrões dos dados brutos. Configura-se, portanto, como 
uma sub-área de inteligência artificial de acordo com 
\cite{Goodfellow-et-al-2016}. Já o aprendizado profundo, ou 
