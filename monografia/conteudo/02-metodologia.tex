...
de Geografia e Estatística (IBGE) e a Fundação Getúlio Vargas (FGV) para prever o consumo mensal de 
cimento nos estados da União.
...
de preparação de dados, como o preenchimento de valores nulos, além de estratégias
de pré-processamento de dados. Para mensurar 
...
Além disso, utilizou-se o método de validação cruzada para avaliar os modelos.


\section{Tecnologias utilizadas}

Este projeto foi implementado na linguagem Python com auxílio de bibliotecas e 
...
\textit{Numpy}, já para o treinamento e avaliação dos modelos utilizou-se a \textit{Tensorflow}
e a \textit{Scikit-learn}
