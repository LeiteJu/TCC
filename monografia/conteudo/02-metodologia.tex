...
Nesta seção é feito um detalhamento dos dados utilizados no trabalho que 
abrange fonte, preparação e pré-processamento. Também são descritas as 
tecnologias utilizadas na implementação, as métricas estatísticas que foram 
usadas para mensurar o desempenho dos modelos e o método de validação
cruzada utilizado para avaliar os modelos.
